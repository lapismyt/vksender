...
source.include_exts = py,png,txt,ogg,kv,atlas,wav,jpg
...
requirements = python3,kivy,kivymd,vk_api,Pillow
...
# (list) Permissions
android.permissions = WAKE_LOCK,INTERNET,READ_EXTERNAL_STORAGE,WRITE_EXTERNAL_STORAGE,MANAGE_EXTERNAL_STORAGE
